  ...
  examples: [
    {
      ...
      output: 'Special values round-trip with their original runtime types and semantics',
    },
    {
      input: '`deserialize(serialize([undefined, BigInt(42), { score: NaN }]))`\nRestores an array whose first value is `undefined`, second value is `42n`, and `score` is `NaN`.',
      output: '`[undefined, 42n, { score: NaN }]`',
    }
  ],
  points: [
